...
setup(
    ...
    name="hsltimes",  # Required

    # Version?
    version="0.0.1b0",  # Required
    ...
    # called 'hsltimes' which executes the function 'main' from
    # file 'main' from package 'hsltimes', when invoked:
